   ...
   <div>
       ...
       <select multiple=""
           data-hs-select='{
                ...
                "toggleClasses": "hs-select-disabled:pointer-events-none hs-select-disabled:opacity-50 relative py-2 ps-4 pe-9 flex gap-x-2 text-nowrap w-full cursor-pointer bg-white border border-gray-200 rounded-lg text-start text-sm  focus:ring-2 focus:ring-zinc-600  dark:bg-{{ $darkToggleColor }}/10 dark:border-neutral-700 dark:text-neutral-400 dark:focus:outline-hidden dark:focus:ring-2 dark:focus:ring-white mt-1",
